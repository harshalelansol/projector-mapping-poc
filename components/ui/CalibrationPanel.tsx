...
import { Paper, Typography, Slider, Box, Switch, FormControlLabel } from '@mui/material';
  ...
  return (
    ...
    >
      <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 2 }}>
        <Typography variant="subtitle2" sx={{ fontWeight: 'bold' }}>Calibration & Projection</Typography>
        <FormControlLabel
            control={
                <Switch 
