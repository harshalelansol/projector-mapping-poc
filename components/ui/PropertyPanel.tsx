...
import { Paper, Typography, Slider, Box, Switch, Select, MenuItem, FormControl } from '@mui/material';
...
const PropertyPanel: React.FC<PropertyPanelProps> = ({ selectedShapes, primaryShape, onChange, onDelete }) => {
  ...
  return (
    ...
    >
      <Typography variant="h6" sx={{ mb: 2, fontWeight: 'bold', color: 'grey.200' }}>
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
        ...
        {!isMulti && primaryShape.type === 'text' && (
            <Box>
                <Typography variant="caption" sx={{ color: 'grey.400' }}>Text Content</Typography>
                <input
                    type="text"
                ...
                />
                 <Typography variant="caption" sx={{ color: 'grey.400' }}>Font Family</Typography>
                 ...
                 <Typography variant="caption" sx={{ color: 'grey.400' }}>Font Size</Typography>
                 <Slider 
        ...
        <Box>
            ...
            {(primaryShape.fillEnabled ?? true) && (
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mt: 0.5 }}>
                    ...
                    />
                    <Typography variant="caption" sx={{ fontFamily: 'monospace' }}>{primaryShape.fill}</Typography>
                </Box>
            )}
        </Box>
        ...
        <Box sx={{ mt: 2, pt: 2, borderTop: '1px solid rgba(255,255,255,0.1)' }}>
            <button
                ...
                onMouseOver={(e) => e.currentTarget.style.backgroundColor = 'rgba(255, 68, 68, 0.3)'}
                onMouseOut={(e) => e.currentTarget.style.backgroundColor = 'rgba(255, 68, 68, 0.2)'}
            >
